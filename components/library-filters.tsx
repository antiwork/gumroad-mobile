...
import { useRightSheet } from "./right-sheet-portal";
...
export const LibraryFilters = ({
  ...
  const { openSheet, closeSheet } = useRightSheet();
  ...
  const openFilterSheet = useCallback(() => {
    openSheet(
      <View className="flex-1 p-4">
        ...
        <TouchableOpacity onPress={closeSheet} className="mt-auto items-center rounded bg-primary px-4 py-3">
  ...
  return (
    <View className="flex-row items-center gap-2 px-4 py-4">
      ...
      <TouchableOpacity onPress={openFilterSheet} className="rounded border border-border bg-background p-2">
