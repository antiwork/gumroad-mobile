      ...
      <QueryProvider>
        <AuthProvider>
          ...
          >
            ...
            <Stack.Screen name="create-product" options={{ title: "Create product", headerLeft: () => <HeaderCloseButton /> }} />
            <Stack.Screen name="edit-product" options={{ title: "Edit product", headerLeft: () => <HeaderCloseButton /> }} />
